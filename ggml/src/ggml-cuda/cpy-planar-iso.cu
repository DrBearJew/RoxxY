...
#define GGML_CUDA_MEMCPY_TO_SYMBOL hipMemcpyToSymbol
#else
#define GGML_CUDA_MEMCPY_TO_SYMBOL cudaMemcpyToSymbol
#endif
...
void ggml_cuda_init_planar_iso_constants() {
    ...
    CUDA_CHECK(GGML_CUDA_MEMCPY_TO_SYMBOL(d_planar_cos, h_cos, sizeof(h_cos)));
    CUDA_CHECK(GGML_CUDA_MEMCPY_TO_SYMBOL(d_planar_sin, h_sin, sizeof(h_sin)));
    ...
    CUDA_CHECK(GGML_CUDA_MEMCPY_TO_SYMBOL(d_iso_qw, h_qw, sizeof(h_qw)));
    CUDA_CHECK(GGML_CUDA_MEMCPY_TO_SYMBOL(d_iso_qx, h_qx, sizeof(h_qx)));
    CUDA_CHECK(GGML_CUDA_MEMCPY_TO_SYMBOL(d_iso_qy, h_qy, sizeof(h_qy)));
    CUDA_CHECK(GGML_CUDA_MEMCPY_TO_SYMBOL(d_iso_qz, h_qz, sizeof(h_qz)));
