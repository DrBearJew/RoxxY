...
bool llama_kv_cache_try_get_mtp_qblock_full_page_authority_dispatch_map(const void * k_view_data, struct ggml_cuda_mtp_qblock_full_page_map_v1 * map, uint64_t * epoch);
