...
enum llm_tensor {
    ...
    LLM_TENSOR_JETSPEC_HIDDEN_NORM,
    LLM_TENSOR_JETSPEC_NORM,
    LLM_TENSOR_JETSPEC_INPUT_LAYERNORM,
    LLM_TENSOR_JETSPEC_MLP_DOWN,
    LLM_TENSOR_JETSPEC_MLP_GATE,
    LLM_TENSOR_JETSPEC_MLP_UP,
    LLM_TENSOR_JETSPEC_POST_ATTENTION_LAYERNORM,
    LLM_TENSOR_JETSPEC_ATTN_K_NORM,
    LLM_TENSOR_JETSPEC_ATTN_K_PROJ,
    LLM_TENSOR_JETSPEC_ATTN_O_PROJ,
    LLM_TENSOR_JETSPEC_ATTN_Q_NORM,
    LLM_TENSOR_JETSPEC_ATTN_Q_PROJ,
    LLM_TENSOR_JETSPEC_ATTN_V_PROJ,
};
