...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_JETSPEC_QWEN3_DRAFT_HEAD, "jetspec_qwen3_draft_head" },
    { LLM_ARCH_PHI2,             "phi2"             },
    { LLM_ARCH_PHI3,             "phi3"             },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_JETSPEC_FC,                             "draft.fc" },
    { LLM_TENSOR_JETSPEC_HIDDEN_NORM,                    "draft.hidden_norm" },
    { LLM_TENSOR_JETSPEC_NORM,                           "draft.norm" },
    { LLM_TENSOR_JETSPEC_INPUT_LAYERNORM,                "draft.layers.%d.input_layernorm" },
    { LLM_TENSOR_JETSPEC_MLP_DOWN,                       "draft.layers.%d.mlp.down_proj" },
    { LLM_TENSOR_JETSPEC_MLP_GATE,                       "draft.layers.%d.mlp.gate_proj" },
    { LLM_TENSOR_JETSPEC_MLP_UP,                         "draft.layers.%d.mlp.up_proj" },
    { LLM_TENSOR_JETSPEC_POST_ATTENTION_LAYERNORM,       "draft.layers.%d.post_attention_layernorm" },
    { LLM_TENSOR_JETSPEC_ATTN_K_NORM,                    "draft.layers.%d.self_attn.k_norm" },
    { LLM_TENSOR_JETSPEC_ATTN_K_PROJ,                    "draft.layers.%d.self_attn.k_proj" },
    { LLM_TENSOR_JETSPEC_ATTN_O_PROJ,                    "draft.layers.%d.self_attn.o_proj" },
    { LLM_TENSOR_JETSPEC_ATTN_Q_NORM,                    "draft.layers.%d.self_attn.q_norm" },
    { LLM_TENSOR_JETSPEC_ATTN_Q_PROJ,                    "draft.layers.%d.self_attn.q_proj" },
    { LLM_TENSOR_JETSPEC_ATTN_V_PROJ,                    "draft.layers.%d.self_attn.v_proj" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_JETSPEC_FC,                         {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_JETSPEC_HIDDEN_NORM,                {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL}},
    {LLM_TENSOR_JETSPEC_NORM,                       {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL}},
    {LLM_TENSOR_JETSPEC_INPUT_LAYERNORM,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_JETSPEC_MLP_DOWN,                   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_JETSPEC_MLP_GATE,                   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_JETSPEC_MLP_UP,                     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_JETSPEC_POST_ATTENTION_LAYERNORM,   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_JETSPEC_ATTN_K_NORM,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_JETSPEC_ATTN_K_PROJ,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_JETSPEC_ATTN_O_PROJ,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_JETSPEC_ATTN_Q_NORM,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_JETSPEC_ATTN_Q_PROJ,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_JETSPEC_ATTN_V_PROJ,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    // Nemotron 3 Super
