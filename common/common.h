...
enum common_speculative_type {
    ...
    COMMON_SPECULATIVE_TYPE_DRAFT_JETSPEC, // JetSpec draft-head speculative decoding (experimental, fail-closed)
...
struct common_params {
    ...
    std::set<std::string> model_tags;      // model tags; router uses pool:/replica:/lane: for pools         // NOLINT
