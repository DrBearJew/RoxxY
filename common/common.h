...
struct common_params {
    ...
    int32_t checkpoint_start_after_nt = 64; // start checkpoints after this many prompt tokens
    int32_t checkpoint_min_spacing_nt = 64; // minimum spacing between context checkpoints
